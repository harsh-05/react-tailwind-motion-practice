...
export default function AnimatedCard() {
  ...
  return (
    <motion.div className="bg-white rounded-xl min-h-104 h-104 w-72 font-sans shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] p-4 flex flex-col ">
      ...
      <div className="flex items-center justify-center mt-7 ">
        <button className="flex items-end justify-center gap-2 text-sm rounded-md shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] py-2 px-4">
          <div>
            <svg
      ...
      <div className="flex-1 bg-gray-100 mt-4 rounded-xl border border-dashed border-neutral-200 relative">
        <motion.div
          ...
          <div className="p-4 flex gap-3">
            ...
            <div className="flex flex-col text-[0.6rem]">
              <p className="font-bold text-neutral-600">Aceternity Messages</p>
              <p className="text-neutral-400">
          ...
          <div className="p-4 flex gap-3">
            ...
            <div className="flex flex-col text-[0.6rem]">
              <p className="font-bold text-neutral-600">24 Hours Turnaround.</p>
              <p className="text-neutral-400">
                All Queries will be resolved within 24 hours or you will get
                refund immediately.
              </p>
            </div>
          </div>
